...
class ImagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'order' => ['type' => 'integer', 'length' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'property_id' => 1,
            'created' => '2016-12-04 15:33:36',
            'modified' => '2016-12-04 15:33:36',
            'order' => 1,
