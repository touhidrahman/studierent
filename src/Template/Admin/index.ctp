...
<!-- @author: Aleksandr Anfilov -->
            ...
            <form method="POST" class="form-inline">
                <div class="form-group">
                    ...
                    <input name="first_name" id="fname" class="form-control" type="text" placeholder="enter first name" required="required">
                    
                    <input name="last_name" id="lname" class="form-control" type="text" placeholder="enter last name" required="required">
