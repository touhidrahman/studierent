 ...
 * @property \Cake\ORM\Association\BelongsTo $ForUsers
 *
...
class FeedbacksTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->requirePresence('relationship_basis', 'create')
            ->notEmpty('relationship_basis');
    ...
    public function buildRules(RulesChecker $rules)
    {
        ...
        // $rules->add($rules->existsIn(['for_user_id'], 'ForUsers'));
